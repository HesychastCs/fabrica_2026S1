...
public class SavingGoalController {
    ...
    @GetMapping("/avance")
    public ResponseEntity<List<com.example.demo.infra.rest.dto.AvanceMetaResponse>> getAvanceMetas(
            @RequestParam UUID titularId) {
        List<com.example.demo.infra.rest.dto.AvanceMetaResponse> avance = savingGoalService.obtenerAvanceMetas(titularId);
